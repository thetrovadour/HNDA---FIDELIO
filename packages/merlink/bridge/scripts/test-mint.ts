...
async function main(): Promise<void> {
  ...
  console.log(`Recipient CATR before : ${ethers.formatUnits(balanceBefore, 18)} CATR`);
  console.log('');

  // Send mint transaction
  console.log('Sending mint() transaction...');
  const amountWei = ethers.parseUnits(TEST_AMOUNT_LEMPIRAS.toString(), 18);
  ...
  console.log(`Recipient CATR after  : ${ethers.formatUnits(balanceAfter, 18)} CATR`);
  console.log(`Delta                 : +${ethers.formatUnits(balanceAfter - balanceBefore, 18)} CATR`);
