  ...
  return (
    <div style={sbStyles.bar}>
      ...
      <div style={sbStyles.right}>
        ...
        <div style={sbStyles.bat}>
          <div style={sbStyles.batFill}/>
        </div>
      </div>
    </div>
  );
...
const pfStyles = {
  outer: { display: 'flex', justifyContent: 'center', padding: '40px 20px', minHeight: '100vh', background: 'radial-gradient(ellipse at center top, rgba(14,165,233,0.06), transparent 60%)' },
  bezel: { width: 390, height: 844, background: '#000', borderRadius: 50, padding: 12, boxShadow: '0 30px 80px rgba(0,0,0,0.6), inset 0 0 0 2px rgba(255,255,255,0.06)', position: 'relative' },
...
const sbStyles = {
  ...
  bat: { width: 24, height: 11, border: '1px solid rgba(241,245,249,0.5)', borderRadius: 3, padding: 1, position: 'relative' },
